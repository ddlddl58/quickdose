...
These coefficients assume uniform radionuclide concentration and semi-infinite sources. They already implicitly include following decay chains where parent and daughter products are in the secular equilibrium (daughters are short lived compared to parents):
